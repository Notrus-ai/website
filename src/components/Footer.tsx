      ...
      <div className="p-4 md:p-16 bg-notrus-tangaroa text-white mb-8">
        <div className="flex flex-col gap-16 md:gap-40 md:flex-row">
          ...
          <div className="flex-1 flex gap-4">
            <ul className="flex-1 group [&>li>a]:p-1 [&>li>a]:block">
              ...
              <li><Link href="/insights" className="group-hover:opacity-50 hover:opacity-100! transition-opacity">{t('insights')}</Link></li>
              <li><Link href="/contact" className="group-hover:opacity-50 hover:opacity-100! transition-opacity">{t('contact')}</Link></li>
            </ul>
          </div>
        </div>
        <div className="flex justify-between pt-8 flex-wrap gap-2">
          ...
          <ul className="flex gap-4 group order-1">
            <li><Link href="/privacy-policy" className="group-hover:opacity-50 hover:opacity-100! transition-opacity">{t('privacyPolicy')}</Link></li>
          </ul>
        </div>
      </div>
    </footer>
